...
<%
String range = request.getParameter("pizzaprice");
String a = range.substring(0,3);
String b = range.substring(4);
try{
	Class.forName("com.mysql.jdbc.Driver");
	Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/miniproject", "root", "");
	Statement st=conn.createStatement();
	String q = "select * from menu where price between '"+a+"' and '"+b+"'";
